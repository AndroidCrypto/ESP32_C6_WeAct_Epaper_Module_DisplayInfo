/*
  The sketch is showing how to connect a WeAct 2.9-inch EPaper Module to an ESP32-C6 Supermini
  microcontroller.
...
// Connections for ESP32-C6 Supermini, trying to have most ADC pins left available
static const uint8_t EPD_BUSY = 16; // to EPD BUSY 16 is labled as 'TX'
static const uint8_t EPD_CS = 20;   // to EPD CS
static const uint8_t EPD_RST = 18;  // to EPD RST
static const uint8_t EPD_DC = 19;   // to EPD DC

static const uint8_t EPD_SCK = 17;   // to EPD CLK 17 is labled as 'RX'
static const uint8_t EPD_MISO = -1; // Master-In Slave-Out not used, as no data from display
static const uint8_t EPD_MOSI = 14; // to EPD DIN / SDA

/*
Wiring of the display to the ESP32-C6 Supermini device. Please double-check the pins on the PCB
...
void setup() {
  ...
  while (!Serial)
    ;
  Serial.println("Esp32-C6 Supermini WeAct 2.9-inch EPaper Module GxPD2 library DisplayInfo v03");
